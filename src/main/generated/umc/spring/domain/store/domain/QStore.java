...
public class QStore extends EntityPathBase<Store> {
    ...
    public final umc.spring.domain.etc.map.domain.QMap map;
    ...
    public final umc.spring.domain.region.domain.QRegion region;
    ...
    public QStore(Class<? extends Store> type, PathMetadata metadata, PathInits inits) {
        ...
        this.map = inits.isInitialized("map") ? new umc.spring.domain.etc.map.domain.QMap(forProperty("map"), inits.get("map")) : null;
        this.region = inits.isInitialized("region") ? new umc.spring.domain.region.domain.QRegion(forProperty("region")) : null;
    }
